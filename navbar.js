(() => {
  ...
  const setupMobileMenu = () => {
    let hamburger = nav.querySelector(".rb-hamburger");
    let mobileMenu = nav.querySelector(".rb-mobile-menu");

    // Si no existen, crearlos
    if (!hamburger) {
      hamburger = document.createElement("button");
      hamburger.className = "rb-hamburger";
      hamburger.setAttribute("aria-label", "Toggle menu");
      hamburger.innerHTML = "<span></span><span></span><span></span>";
      nav.querySelector(".rb-nav-row").appendChild(hamburger);
    }

    if (!mobileMenu) {
      const navRow = nav.querySelector(".rb-nav-row");
      mobileMenu = document.createElement("div");
      mobileMenu.className = "rb-mobile-menu";

      const menuItems = nav.querySelectorAll(".rb-menu .rb-item");
      ...
      navRow.parentElement.appendChild(mobileMenu);
    }
  ...
  // Call setupMobileMenu after DOM is ready
